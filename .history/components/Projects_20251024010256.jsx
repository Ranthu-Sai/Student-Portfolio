...
const projectData = [
  ...
  {
    title: 'Scalable RESTful API Service',
    description:
      'A robust backend service built with Java and Spring Boot, providing a well-documented RESTful API for a hypothetical e-commerce platform.',
    image: 'https://picsum.photos/seed/project4/500/300',
    tags: ['Java', 'Spring Boot', 'REST API', 'PostgreSQL', 'Docker'],
    codeLink: 'https://github.com/sai-ranthu/rest-api-service',
    demoLink: '#',
  },
];
